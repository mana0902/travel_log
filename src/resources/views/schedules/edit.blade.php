      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <section class="text-gray-600 body-font relative text-center">
            <div class="container px-5 py-24 mx-auto">
              <form method="post" action="{{route('posts.dates.schedules.update',['post'=>$post_id,'date'=>$date_id,'schedule'=>$schedule_id])}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
              <div class="lg:w-1/2 md:w-2/3 mx-auto ">
                <div class=" -m-2">
                  <div class="p-5 ">
                    <div class="relative">
                      ...
                      <input type="time" value="{{$schedule->start_time}}" id="start_time" name="start_time" class="drop-shadow-xl w-full bg-gray-20 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                  ...
                  <div class="p-5 ">
                    <div class="relative">
                      ...
                      <input type="time" value="{{$schedule->end_time}}" id="end_time" name="end_time" class="drop-shadow-xl w-full bg-gray-20 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  ...
                  <div class="p-5 ">
                    <div class="relative">
                      ...
                      <input type="text" value="{{$schedule->destination}}" id="destination" name="destination" class="drop-shadow-xl w-full bg-gray-20 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  ...
                  <div class="p-5 ">
                    <div class="relative">
                      ...
                      <textarea type="text" value="" id="comment" name="comment" class="drop-shadow-xl w-full bg-gray-20 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{$schedule->comment}}</textarea>
                ...
                <div class="flex">
                  <div class="p-10 w-full">
                    ...
                    <div class="p-10 w-full">
                      <button onclick=location.href='{{ route('posts.show',['post'=>$post_id]) }}' type="button" class="drop-shadow-xl flex mx-auto text-white bg-[#22c55e] border-0 py-2 px-8 focus:outline-none hover:bg-[#16a34a] rounded text-lg">戻る</button>
                  </div>
                </div>
