  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <section class="text-gray-600 body-font">
            <div class="title-font p-10 w-15 bg-blue-100">
                {{$key['date']}}
            </div>
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="pl-10 lg:flex-grow md:w-1/5 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                  <p class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 leading-relaxed">
                      11:00
                  </p>
                  <div class="ml-11 title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">|</div>
                  <p class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 mb-8 leading-relaxed">
                      12:00
                  </p>
                </div>
